    ...
    try:
        ...
        with open(file_path, "rb") as f:
            for line in iter(lambda: f.read(4096), b""):
                ...
                sha256_file = hash_sha256.hexdigest()
        return sha256_file
...
if __name__ == '__main__':
    ...
    print(get_sha256("Practica4/mystery_img.txt"))
    print(get_sha256("Practica4/mystery_img2.txt"))
    print(get_sha256("Practica4/msg.txt"))

    imagen1 = decode_file("Practica4/mystery_img.txt")
    save_file("Practica4/mystery_img.png",imagen1)

    imagen2 = decode_file("Practica4/mystery_img2.txt")
    save_file("Practica4/mystery_img2.png",imagen2)

    encode_txt = encode_file("Practica4/msg.txt")
    save_file("Practica4/encode_msg.txt",encode_txt)